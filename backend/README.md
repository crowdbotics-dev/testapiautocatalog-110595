...
## Project Structure
    ...
    ├── testapiautocatalog_110595  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_110595`
...
2. Clone this repo and `cd testapiautocatalog_110595`
